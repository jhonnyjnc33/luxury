...
$amenidad= lista($link, "comentario_articulo", "", "");
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Comentarios Blog</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                                    ...
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        <thead class="bordered-darkorange">
                                            <tr role="row">
                                                ...
                                                <th width="30%">Art&iacute;culo</th>
                                        ...
                                        <?
                                        	...
                                        	foreach ($amenidad as $am){
                                        		...
                                        		$titulo_articulo= devuelve_campo_c("titulo", "articulos", "id_articulo", $am["articulo"], $link);
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id"].'">
		                                                <td class=" sorting_1">'.$am["nombre"].'</td>
		                                                <td class=" sorting_1">'.$am["correo"].'</td>
		                                                <td class=" sorting_1">'.$titulo_articulo.'</td>
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/comentarios-blog/edicion.php?id='.$am["id"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                </td>
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id"].'">
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="comentario_articulo" id="'.$am["id"].'" data-dato="id_comentario_articulo" from-data="amenidad">Si</span>
