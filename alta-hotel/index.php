...
<head>
    <meta charset="utf-8" />
    <title> Alta de Hotel | Xangos</title>
			                                                           		...
			                                                           		<div class="col-sm-6">
					                                                            ...
					                                                            <div class="form-group">
					                                                                ...
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="text" name="nombre" placeholder="Nombre esp" id="userameInput" class="form-control">
					                                                                    ...
					                                                                    <select name="destino" class="form-control">
					                                                                    	...
					                                                                    	<?php
					                                                                    		foreach ($a as $aa){
					                                                                    			...
					                                                                    			print '
					                                                                    				<option value="'.$aa["id"].'"> '.$aa["nombre_esp"].' </option>
					                                                                    			';
					                                                                    		}
					                                                                    	?>
					                                                                    </select>
			                                                            	...
			                                                            	<div class="col-sm-4">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="text" name="telefono1" placeholder="" id="userameInput" class="form-control">
					                                                                </span>
					                                                            </div>
				                                                            </div>
			                                                            	<div class="col-sm-4">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="text" name="telefono2" placeholder="" id="userameInput" class="form-control">
					                                                                </span>
					                                                            </div>
				                                                            </div>
			                                                            	<div class="col-sm-4">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="text" name="correo" placeholder="" id="userameInput" class="form-control">
					                                                                </span>
					                                                            </div>
				                                                            </div>
