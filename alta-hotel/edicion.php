...
$c= 'SELECT * FROM hoteles where id_hotel='.$_GET["id"]; 
...
$a= lista($link, "aldeas", "order by nombre_esp", "", "", "");
?>
				...
				-->
                                                	...
                                                	<div class="tab-content">
			                                                           		...
			                                                           		<div class="col-sm-6">
					                                                            ...
					                                                            <div class="form-group">
					                                                                ...
					                                                                <span class="input-icon icon-right">
																						<label>Nombre</label>
					                                                                    <input type="hidden" name="seccion" placeholder="" id="userameInput" class="form-control" value="hotel"> 
																						<input type="hidden" name="id"  class="form-control" value="<?php print $ccc["id_hotel"]?>"> 
					                                                                    <input type="text" name="nombre"  id="userameInput" class="form-control" value="<?php print $ccc["nombre"];?>" >
					                                                            ...
					                                                            <div class="form-group">
					                                                                ...
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <select class="form-control" name="destino">
					                                                                    	...
					                                                                    	<?php
					                                                                    		foreach ($a as $aa){
					                                                                    			if($ccc["destino"]== $aa["id"])
					                                                                    				print '<option value="'.$aa["id"].'" selected> '.$aa["nombre_esp"].' </option>';
					                                                                    			else
					                                                                    				print '<option value="'.$aa["id"].'" > '.$aa["nombre_esp"].' </option>';
					                                                                    		}
					                                                                    	?>
					                                                                    </select>
					                                                            ...
					                                                            <div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                   ...
						                                                                   <input type="text" value="<?php print $ccc["direccion"]?>" name="direccion" class="form-control" />
			                                                            ...
			                                                            <div class="row">
			                                                            	<div class="col-sm-4">
			                                                            		<div class="form-group">
			                                                            			...
			                                                            			<input type="text" value="<?php print $ccc["telefono1"]?>" name="telefono1" class="form-control" />
			                                                            		</div>
			                                                            	</div>
			                                                            	<div class="col-sm-4">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                   ...
						                                                                   <input type="text" value="<?php print $ccc["telefono2"]?>" name="telefono2" class="form-control" />
						                                                                </span>
						                                                            </div>
					                                                            </div>
			                                                            	<div class="col-sm-4">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                   ...
						                                                                   <input type="text" value="<?php print $ccc["correo"]?>" name="telefono2" class="form-control" />
						                                                                </span>
						                                                            </div>
					                                                            </div>
			                                                            </div>
		                                                    ...
		                                                    <div id="profile" class="tab-pane">
																<?php
																	$img = mostrar_img($link, $ccc["id_categoria"], "categoria", "icono");
						                                    		print '<img src="/images/categoria_img/'.$img["imagen"].'" class="header-avatar" width="100" style="margin-bottom: 10px;"/>';
																						?>
