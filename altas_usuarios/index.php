...
$perfil= all($link, "type_user", "order by nombre", '?_pagi_pg=');
                                                	...
                                                	<div class="tab-content">
			                                                           ...
			                                                           <div class="row">
			                                                            ...
			                                                            <div class="row">
				                                                            <div class="col-sm-6">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    <input type="text" placeholder="tel&eacute;fono" name="telefono" id="" class="form-control">
				                                                            ...
				                                                            <div class="col-sm-6">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    <input type="text" placeholder="Direcci&oacute;n" id="confirmPasswordInput" name="direccion" class="form-control">
			                                                            ...
			                                                            <div class="row">
				                                                            <div class="col-sm-6">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    <input type="text" placeholder="Usuario" id="confirmPasswordInput" name="usuario" class="form-control">
				                                                            ...
				                                                            <div class="col-sm-6">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    <input type="text" placeholder="contrase&ntilde;a" id="confirmPasswordInput" name="pass" class="form-control">
		                                                    ...
		                                                    <div id="profile" class="tab-pane">
		                                                    	...
		                                                    	<style>
																	...
																	<div id="file_in">
																		<p>Arrastrar  o click para subir imagen de perfil <i>Medida recomendada 256px * 256px</i></p>
