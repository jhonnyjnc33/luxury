...
$amenidad= all($link, "slider", "order by id_slider asc", "");
                                ...
                                <div class="widget-body no-padding table-scrollable">
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        <thead class="bordered-darkorange">
                                            <tr role="row">
                                                <th width="30%">Titulo esp</th>
                                                <th width="">Titulo 2 esp</th>
                                        ...
                                        <?
                                        	foreach ($amenidad as $am){
                                        		...
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id_slider"].'">
		                                                <td class=" sorting_1">'.$am["titulo_esp"].'</td>
		                                                <td class=" ">'.$am["titulo2_esp"].'</td>
		                                                
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/agregar-slider/edicion.php?id='.$am["id_slider"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                		
		                                                </td>
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id_slider"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id_slider"].'">
		                                                			
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="slider" id="'.$am["id_slider"].'" data-dato="id_slider" from-data="amenidad">SI</span>
				                                                			<span class="eliminar_no" from-data="amenidad" id="'.$am["id_slider"].'">No</span>
		                                                				</div>
		                                                		</div>
		                                                </td>
                                            		</tr>
