...
$amenidad= all($link, "categoria_blog", "order by nombre_esp asc");
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Categor&iacute;as Blog</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                                    ...
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        ...
                                        <?
                                        	foreach ($amenidad as $am){
                                        		...
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id_categoria_blog"].'">
		                                                <td class=" sorting_1">'.$am["nombre_esp"].'</td>
		                                                <td class=" sorting_1">'.$am["tag_title_esp"].'</td>
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/blog-categorias/edicion.php?id='.$am["id_categoria_blog"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                		
		                                                </td>
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id_categoria_blog"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id_categoria_blog"].'">
		                                                			
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="categoria_blog" id="'.$am["id_categoria_blog"].'" data-dato="id_categoria_blog" from-data="amenidad">Si</span>
				                                                			<span class="eliminar_no" from-data="amenidad" id="'.$am["id_categoria_blog"].'">No</span>
		                                                				</div>
		                                                		</div>
		                                                </td>
                                            		</tr>
