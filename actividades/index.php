...
$amenidad= lista($link, "actividades", "order by nombre_esp asc", "");
...
<head>
    <meta charset="utf-8" />
    <title>Actividades - Xangos</title>
                                        	...
                                        	foreach ($amenidad as $am){
                                        		...
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id"].'">
		                                                ...
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar"  class="btn btn-default btn-sm  icon-only success" alt="Editar" href="/agregar-actividades/edicion.php?id='.$am["id"].'"><i class="fa fa-edit"></i></a>
		                                                ...
		                                                <td>	
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id"].'"><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id"].'">
			                                                			...
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="actividades" id="'.$am["id"].'" data-dato="id_actividad" from-data="amenidad">SI</span>
