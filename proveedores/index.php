...
$amenidad= lista($link, "proveedores", "order by nombre_comercial asc", "");
                                        	...
                                        	foreach ($amenidad as $am){
                                        		...
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id"].'">
		                                                <td class=" sorting_1">'.$am["clave"].'</td>
		                                                <td class=" sorting_1">'.$am["nombre_comercial"].'</td>
		                                                <td class=" sorting_1">'.$am["contacto"].'</td>
		                                                <td class=" sorting_1">'.$am["telefono"].'</td>
		                                                
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/alta-proveedor/edicion.php?id='.$am["id"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                ...
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id"].'">
			                                                			...
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="proveedores" id="'.$am["id"].'" data-dato="id_proveedor" from-data="amenidad">SI</span>
