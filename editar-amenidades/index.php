...
$amenidad= lista($link, "amenidades", "order by nombre_esp asc", "");
?>
<!DOCTYPE html>
<!--
                                ...
                                <div class="widget-body no-padding table-scrollable">
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        <thead class="bordered-darkorange">
                                            <tr role="row">
                                                <th width="30%">Nombre Esp</th>
                                                <th width="30%">Nombre Eng</th>
                                        ...
                                        <?
                                        	foreach ($amenidad as $am){
                                        		...
                                        		$hora= devuelve_campo_c("hora", "horario", "id_horario", $am["horario"], $link);
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id"].'">
		                                                <td class=" sorting_1">'.$am["nombre_esp"].'</td>
		                                                <td class=" sorting_1">'.$am["nombre_eng"].'</td>
		                                                
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/altas_amenidades/edicion.php?id='.$am["id"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                ...
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id"].'">
			                                                			...
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="amenidades" id="'.$am["id"].'" data-dato="id_amenidad" from-data="amenidad">Si</span>
