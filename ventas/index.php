...
$amenidad= all($link, "compras", "order by fechaCompra desc");
                                    ...
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        ...
                                        <?
                                        	foreach ($amenidad as $am){
                                        		...
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id_compra"].'">
		                                                <td class=" sorting_1">AF'.ceros($am["id_compra"], 4).'</td>
		                                                <td class=" ">'.$am["nombre"].' '.$am["apellido"].'</td>
		                                                <td class=" ">'.$am["fechaCompra"].'</td>
		                                                <td class=" ">'.$pago.'</td>
		                                                
		                                                <td class=" ">'.$am["status"].'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/ventas/edicion.php?id='.$am["id_compra"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                		
		                                                </td>
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id_compra"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id_compra"].'">
		                                                			
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="compras" id="'.$am["id_compra"].'" data-dato="id_compra" from-data="amenidad">SI</span>
				                                                			<span class="eliminar_no" from-data="amenidad" id="'.$am["id_compra"].'">No</span>
		                                                				</div>
		                                                		</div>
		                                                </td>
                                            		</tr>
