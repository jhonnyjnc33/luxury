...
$amenidad= all($link, "articulos", "order by fecha asc");
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Art&iacute;culos Blog</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                                    ...
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        ...
                                        <?
                                        	foreach ($amenidad as $am){
                                        		...
                                        		$condominio= devuelve_campo_c("nombre_esp", "condominios", "id_condominio", $am["condominio"], $link);
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id_articulo"].'">
		                                                <td class=" sorting_1">'.$am["titulo_esp"].'</td>
		                                                <td class=" sorting_1">'.$am["tag_title_esp"].'</td>
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/blog-articulos/edicion.php?id='.$am["id_articulo"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                		
		                                                </td>
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id_articulo"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id_articulo"].'">
		                                                			
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="articulos" id="'.$am["id_articulo"].'" data-dato="id_articulo" from-data="amenidad">Si</span>
				                                                			<span class="eliminar_no" from-data="amenidad" id="'.$am["id_articulo"].'">No</span>
		                                                				</div>
		                                                		</div>
		                                                </td>
                                            		</tr>
