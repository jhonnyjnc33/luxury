...
$c= 'SELECT * FROM amenidades where id_amenidad='.$_GET["id"]; 
...
<head>
    ...
    <title> Edicion de Amenidades</title>
				...
				-->
                                                	...
                                                	<div class="tab-content">
			                                                           		...
			                                                           		<div class="col-sm-6">
					                                                            ...
					                                                            <div class="form-group">
					                                                                ...
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="hidden" name="seccion" placeholder="" id="userameInput" class="form-control" value="amenidades">
																						<input type="hidden" name="id" placeholder="" id="" class="form-control" value="<?php print $ccc["id_amenidad"]?>">
		                                                    ...
		                                                    <div id="profile" class="tab-pane">
																<?php
																	$img = mostrar_img($link, $ccc["id_amenidad"], "amenidad", "icono");
																	foreach($img as $i){
																		$imagen= $i["imagen"] ;
																	}
						                                    		print '<img src="/images/amenidad_img/'.$imagen.'" class="header-avatar" width="100" style="margin-bottom: 10px;"/>';
																						?>
