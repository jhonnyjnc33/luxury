...
$amenidad= lista($link, "tour", "where circuito='on' order by nombre_esp asc", "");
?>
<!DOCTYPE html>
<!--
                                    ...
                                    <table class="table table-bordered table-hover table-striped" id="searchable">
                                        ...
                                        <?
                                        	foreach ($amenidad as $am){
                                        		...
                                        		$proveedor= devuelve_campo_c("nombre_comercial", "proveedores", "id_proveedor", $am["proveedor"], $link); 
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id"].'">
		                                                ...
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/alta-circuito/edicion.php?id='.$am["id"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                ...
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id"].'">
			                                                			...
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="tour" id="'.$am["id"].'" data-dato="id_tour" from-data="amenidad">SI</span>
