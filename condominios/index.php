...
$amenidad= lista($link, "condominios", "order by nombre_esp asc", "");
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Condominios - Amenidades</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
                                        	...
                                        	foreach ($amenidad as $am){
                                        		...
                                        		print '
                                        			<tr id="fila_amenidad_'.$am["id"].'">
		                                                ...
		                                                <td class=" sorting_1">'.$am["unidades"].'</td>
		                                                <td class=" ">'.$am["area_total"].' M<sup>2</sup></td>
		                                                <td class=" ">'.$am["area_comun"].' M<sup>2</sup></td>
		                                                <td class=" ">'.$status.'</td>
		                                                <td class=" ">
		                                                		<a title="Editar" alt="Editar" href="/altas_condominios/edicion.php?id='.$am["id"].'" class="btn btn-default btn-sm  icon-only success"><i class="fa fa-edit"></i></a>
		                                                ...
		                                                <td>
		                                                	<a title="Eliminar" alt="Eliminar" href="#" class="eliminar btn btn-default btn-sm shiny icon-only danger" from-data="amenidad" id="'.$am["id"].'" ><i class="fa fa-close"></i></a>
		                                                		<div class="eliminar_show" id="text_amenidad_'.$am["id"].'">
			                                                			...
			                                                			&iquest;Eliminar?
			                                                			<div>
				                                                			<span class="elim" data-table="condominios" id="'.$am["id"].'" data-dato="id_condominio" from-data="amenidad">SI</span>
