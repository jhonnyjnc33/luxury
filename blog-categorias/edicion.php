...
$condo= datos_individuales_i($link, "categoria_blog", "id_categoria_blog", $_GET["id"]);
...
<head>
    <meta charset="utf-8" />
    <title> Edici&oacute;n de Blog Categorias</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/editar-categorias">Categor&iacute;as Blog</a>
                        </li>
                        <li>
                            Edici&oacute;n de Categor&iacute;a Blog
                        </li>
			                                                           		...
			                                                           		<div class="col-sm-6">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="hidden" name="seccion" placeholder="" id="userameInput" class="form-control" value="blog_categoria">
					                                                                    <input type="text" name="nombre" class="form-control" value="<?php print $condo["nombre_esp"]?>">
				                                                            ...
				                                                            <div class="row">
					                                                            ...
					                                                            <div class="col-sm-6">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                    ...
						                                                                    <input id="condominio" name="tag_title" class="form-control" value="<?php print $condo["tag_title_esp"]?>">
					                                                            ...
					                                                            <div class="col-sm-6">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                	<label>Url esp</label>
						                                                                    <input id="condominio" name="url" class="form-control" value="<?php print $condo["url_esp"]?>">
			                                                            ...
			                                                            <div class="row">
			                                                            	<div class="col-sm-12">
			                                                            		<div class="form-group">
			                                                            			...
			                                                            			<textarea name="tag_description"  class="form-control" rows="7"><?php print $condo["tag_description_esp"]?></textarea>
			                                                            		</div>
			                                                            	</div>
			                                                            	<div class="col-sm-12">
			                                                            		<div class="form-group">
