...
$sub=datos_individuales_i($link, "subcategoria", "id_subcategoria", $_GET["id"]);
$cat= all($link, "categorias", "where status='on' order by nombre_esp asc");
if($sub["status"]== "on"){
	$status= 'checked';
}else{
	$status='';
...
<head>
    ...
    <title> Edicion de Subcategoria | Deleitate</title>
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            Edici&oacute;n de Subcategoria
                        </li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb --> 
			                                                           		...
			                                                           		<div class="col-sm-4">
					                                                            ...
					                                                            <div class="form-group">
					                                                                ...
					                                                                <span class="input-icon icon-right">
																						<label>Clave</label>
					                                                                    <input type="hidden" name="seccion" placeholder="" id="userameInput" class="form-control" value="subcategorias"> 
																						<input type="hidden" name="id" placeholder="" id="" class="form-control" value="<?php print $sub["id_subcategoria"]?>">
					                                                                   <input type="text" name="nombre_esp" placeholder=""  class="form-control" value="<?php print $sub["nombre_esp"]?>">
					                                                                </span>
					                                                            </div>
				                                                            </div>
				                                                            <div class="col-sm-4">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
																						<label>Nombre Eng</i>)</label>
					                                                                    <input type="text" name="nombre_eng" placeholder=""   class="form-control" value="<?php print $sub["nombre_eng"]?>">
					                                                                </span>
					                                                            </div>
				                                                            </div>
				                                                            <div class="col-sm-4">
					                                                                    ...
					                                                                    <select class="form-control" name="categoria" >
					                                                                    	...
					                                                                    	<?php
					                                                                    		foreach ($cat as $key => $value) {
					                                                                    			if($value["id_categoria"]== $sub["categoria_id"]){
					                                                                    				print '<option value="'.$value["id_categoria"].'" selected>'.$value["nombre_esp"].'</option>';
					                                                                    			}else{
					                                                                    				print '<option value="'.$value["id_categoria"].'" >'.$value["nombre_esp"].'</option>';
					                                                                    			}
					                                                                    		}
					                                                                    	?>
					                                                                    </select>
					                                                            ...
					                                                            <div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                    ...
						                                                                    <textarea name="tag_title_esp" placeholder="" class="form-control" rows="7"><?php print $sub["tag_title_esp"]?></textarea>
			                                                            ...
			                                                            <div class="row">
			                                                            	<div class="col-sm-12">
			                                                            		<div class="form-group">
			                                                            			...
			                                                            			<textarea name="tag_description_esp" placeholder="" class="form-control" rows="7"><?php print $sub["tag_description_esp"]?></textarea>
			                                                            		</div>
			                                                            	</div>
			                                                            	<div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                	<label>Url esp</label>
						                                                                    <input id="condominio" name="url_esp" class="form-control" value="<?php print $sub["url_esp"]?>">
					                                                            ...
					                                                            <div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                    ...
						                                                                    <textarea name="tag_title_eng" placeholder="" class="form-control" rows="7"><?php print $sub["tag_description_eng"]?></textarea>
			                                                            ...
			                                                            <div class="row">
			                                                            	<div class="col-sm-12">
			                                                            		<div class="form-group">
			                                                            			...
			                                                            			<textarea name="tag_description_eng" placeholder="" class="form-control" rows="7"><?php print $sub["tag_description_eng"]?></textarea>
			                                                            		</div>
			                                                            	</div>
			                                                            	<div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                	<label>Url eng</label>
						                                                                    <input id="condominio" name="url_eng" class="form-control" value="<?php print $sub["url_eng"]?>">
						                                                                    <i style="font-size:11px">La url debe contener palabras clave y estar separas por gu&iacute;ion medio, Ejmplo: compra-casa-cancun</i>	
						                                                                </span>
						                                                            </div>
					                                                            </div>
