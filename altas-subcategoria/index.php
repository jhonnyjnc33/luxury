...
<head>
    <meta charset="utf-8" />
    <title> Alta de subcategoria| Deleitate</title>
			                                                           		...
			                                                           		<div class="col-sm-4">
					                                                            ...
					                                                            <div class="form-group">
					                                                                ...
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="text" name="nombre_esp" placeholder=""  class="form-control">
				                                                            ...
				                                                            <div class="col-sm-4">
					                                                            <div class="form-group">
					                                                                <span class="input-icon icon-right">
					                                                                    ...
					                                                                    <input type="text" name="nombre_eng" placeholder=""  value="" class="form-control">
					                                                                </span>
					                                                            </div>
				                                                            </div>
				                                                            <div class="col-sm-4">
					                                                            ...
					                                                            <div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                    ...
						                                                                    <textarea name="tag_title_esp" placeholder="" class="form-control" rows="7"></textarea>
					                                                            ...
					                                                            <div class="col-sm-12">
						                                                            <div class="form-group">
						                                                                <span class="input-icon icon-right">
						                                                                    ...
						                                                                    <textarea name="tag_title_eng" placeholder="" class="form-control" rows="7"></textarea>
