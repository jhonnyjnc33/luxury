...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    ...
    <h1 style="display: inline;">HTML2PDF</h1>
    <h3 style="display: inline; >v<?php echo __CLASS_HTML2PDF__; ?></h3><br>
    <br><br><br><br><br>
    <div style="text-align: center; width: 100%;">
        <br>
        <img src="../../../images/logo-delli.png" alt="Logo HTML2PDF" style="width: 150mm">
        <br>
    </div>
    <br><br><br><br><br>
    <div class="note">
